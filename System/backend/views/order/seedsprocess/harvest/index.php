...
foreach($seedsArrive AS $item){
    ...
    switch ($fechaEvaluada) {
        case $primero:
            $item->action = 'the variety '.$item->hybridIdHybr->motherIdMother->variety." is ready for harvest at the compartment ".$item->compartmentIdCompartment->compNum.".";
            continue;
    }
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::button('<span class="glyphicon glyphicon-pencil"></span>', ['value' => Url::to('index.php?r=order%2Fupdate&id='.$model->idorder.'&name=harvest'), 'class' => 'modalButtonEdit'], [
                            'title' => Yii::t('app', 'Update'),
                        ]);
                    },

                    'delete' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', 'index.php?r=order/delete&id='.$model->idorder.'&name=harvest', [
                            'data-method' => 'POST',
                            'title' => Yii::t('app', 'Update'),
