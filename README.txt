...
4) in your cmd run the command: "composer update".
5) go to the next link where 127.0.0.1 is your server ip: '127.0.0.1/System/backend/web/'.
6) Logg in with the credentials: 
